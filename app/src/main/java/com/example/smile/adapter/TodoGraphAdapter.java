...
public class TodoGraphAdapter extends RecyclerView.Adapter<TodoContentRecycleAdapter.TodoViewHolder> {

    List<TodoEntity> DataBases;
    Context context;
    private TodoContentRecycleAdapter.OnItemClickListener onItemClickListener;
    ...
    public TodoGraphAdapter(Context context) {
        super();
    ...
    public TodoContentRecycleAdapter.OnItemClickListener getOnItemClickListener() {
        return onItemClickListener;
    }

    public void setOnItemClickListener(TodoContentRecycleAdapter.OnItemClickListener onItemClickListener) {
        this.onItemClickListener = onItemClickListener;
    }

    @NonNull
    @Override
    public TodoContentRecycleAdapter.TodoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater =LayoutInflater.from(parent.getContext());
        View itemView =inflater.inflate(R.layout.todo_content_item, parent, false);

        return new TodoContentRecycleAdapter.TodoViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull TodoContentRecycleAdapter.TodoViewHolder holder, int position) {
